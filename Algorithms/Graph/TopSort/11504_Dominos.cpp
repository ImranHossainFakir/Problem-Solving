/*
 Simple DFS problem like finding the connected components.
 But the given graph is not a bidirectional graph so for finding out the
 knock downs at first we need to find out the maximum finishing time nodes.
 Time Complexity : O(n+m) where n is nodes number and m is edges number.
*/
