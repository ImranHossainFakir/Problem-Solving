...
* we have to find out the Minimum value in a given range. We used segment tree solution to store minimum value of all possibles ranges.
* time : O(4*n) for buil, O(log n) for query.
*/
